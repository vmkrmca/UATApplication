...
public class EventRegisterUserActivity extends Activity implements EventRequestListener{
    ...
    public void onEventRequest(EventRequest mEventRequest, int requestValue) {
        ...
        if (requestValue == 1001) {
            // APPROVAL
            mDbHelper.updateEventDetails(mEventRequest.eventID,mEventRequest.emailAddress,"true");
            mDbHelper.updateApprovalStatus(mEventRequest.emailAddress,"true");
            ...
            mDbHelper.updateEventDetails(mEventRequest.eventID,mEventRequest.emailAddress,"false");
            mDbHelper.updateApprovalStatus(mEventRequest.emailAddress,"false");
