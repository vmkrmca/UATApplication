...
public class CreateEventActivity extends Activity implements View.OnClickListener {
    ...
    EditText etEventID,etTitle,etDescription,etEventDate,etEventTime,etEventImage;
        ...
        switch (v.getId()) {
            ...
            case R.id.tvCreateAnEvent:
                ...
                if (eventID.isEmpty()) {
                    ...
                    mEvent.setEventStatus("false");
                    mEvent.setStudEmailAddress("");
                    ...
                    if (id != -1){
                        ...
                        Toast.makeText(this,"EventID is already Created try with Different ID",Toast.LENGTH_SHORT).show();
                    }
                }
                break;
        }
