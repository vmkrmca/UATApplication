...
public class StudentDashBoard extends Activity implements View.OnClickListener, RequestEventClickListener {
    ...
    public void onRequestClick(Event mEvent) {
        ...
        long id = mDbHelper.insertRequestEventDetails(mEvent.eventID,emailAddress, mobileNumber, eventTitle, eventDate, eventTime,"false");

        if (id != -1) {

            mDbHelper.updateEventDetails(mEvent.eventID,emailAddress,"false");
